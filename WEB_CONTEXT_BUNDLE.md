...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-996-erd-s-problem-996-12ef0c72-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-996"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-996-erd-s-problem-996-12ef0c72-v1",
      "problem_contract_sha256": "d556a5f82dfcd568723de5540c6747062d36d6110215b3125bce29ce9e3409cd",
      "problem_id": "problem:um-ep-996-erd-s-problem-996-12ef0c72",
      "route_id": "route:um-ep-996-erd-s-problem-996-12ef0c72-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-996-erd-s-problem-996-12ef0c72-source-fidelity-01",
      "graph_id": "graph:um-ep-996-erd-s-problem-996-12ef0c72-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-996-erd-s-problem-996-12ef0c72-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-996-erd-s-problem-996-12ef0c72-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $n_1<n_2<\\cdots$ be a lacunary sequence of integers, and let $f\\in L^2([0,1])$. Let $f_n$ be the $n$th partial sum of the Fourier series of $f(x)$. Is there an absolute constant $C>0$ such that, if $ \\| f-f_n\\|_2 \\ll \\frac{1}{(\\log\\log\\log n)^{C}} $ then $ \\lim_{N\\to\\infty}\\frac{1}{N}\\sum_{k\\leq N}f(\\{\\alpha n_k\\})=\\int_0^1 f(x)\\mathrm{d}x $ for almost every $\\alpha$?"
          },
          "statement_sha256": "c4af7fe267b92ca2dd2f3386d1aa15c3c0811e167ff1af4e62f00bbc15def412"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-996-erd-s-problem-996-12ef0c72-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-996-erd-s-problem-996-12ef0c72-root",
      "route_id": "route:um-ep-996-erd-s-problem-996-12ef0c72-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-996-4cbbf74d6a0e",
        "url": "https://www.unsolvedmath.com/problems/EP-996"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
